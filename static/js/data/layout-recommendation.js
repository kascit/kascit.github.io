...
function isSidebarExpanded() {
  ...
  const classCollapsed = !!(
    drawer && drawer.classList.contains("sidebar-collapsed")
  );
...
function buildPrompt() {
  ...
  text.textContent =
    "Reading width is tight at this size. For better readability, hide either the sidebar or the right rail.";
