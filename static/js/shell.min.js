...
`;function xe(){if(document.getElementById("access-wall-styles"))return;let e=document.createElement("style");e.id="access-wall-styles",e.textContent=Ee,document.head.appendChild(e)}function V(e={},t=null){let n=e.requireAdmin===!0;if(!(e.requireAuth===!0||n))return{allowed:!0};let a=t?.authenticated===!0,i=t?.role||"guest";return a?n&&i!=="admin"?{allowed:!1,reason:"admin_required"}:{allowed:!0}:{allowed:!1,reason:"auth_required"}}function Y(e,t="auth_required",n="This app"){if(!e)return;xe();let o=t==="admin_required",a=o?"fa-solid fa-shield-halved":"fa-solid fa-lock",i=o?"Admin access required":"Sign in to continue",r=o?`${n} is restricted to administrator sessions.`:`${n} requires a dhanur.me account to continue.`,l=o?"Verify Admin":"Sign In",s=o?"upgrade-btn":"login-btn";e.innerHTML=`
  ...
  `;let c=window.AUTH;if(t==="admin_required"){let h=e.querySelector('[data-auth="upgrade-btn"]');h&&c&&typeof c.upgrade=="function"&&h.addEventListener("click",f=>{f.preventDefault(),c.upgrade()});return}let u=e.querySelector('[data-auth="login-btn"]');u&&c&&typeof c.login=="function"&&u.addEventListener("click",h=>{h.preventDefault(),c.login()})}var _e="dhanur_manifest_v1";var Me=[{name:"Home",url:"https://dhanur.me",icon:"fa-solid fa-house",minRole:"guest"},{name:"Linkr",url:"https://linkr.dhanur.me",icon:"fa-solid fa-link",minRole:"guest"},{name:"Tasks",url:"https://tasks.dhanur.me",icon:"fa-solid fa-clipboard-list",minRole:"guest"},{name:"Auth",url:"https://auth.dhanur.me",icon:"fa-solid fa-fingerprint",minRole:"guest"},{name:"Status",url:"https://up.dhanur.me",icon:"fa-solid fa-heart-pulse",minRole:"guest",category:"Core"}],q=null;function Z(e){return e==="admin"?2:e==="user"?1:0}function Te(){try{let e=localStorage.getItem(_e);if(!e)return null;let t=JSON.parse(e);if(!t||!Array.isArray(t.apps))return null;let n=Number(t._cachedAt||0);return{...t,_stale:Date.now()-n>36e5}}catch{return null}}function R(){if(q&&Array.isArray(q.apps))return q;let e=Te();return e&&Array.isArray(e.apps)?(q=e,e):{version:"0",apps:Me,_stale:!0}}function $(e,t="guest"){let n=Z(t);return(Array.isArray(e)?e:[]).filter(o=>Z(o?.minRole||"guest")<=n)}var ee=!1;function E(){document.querySelectorAll("[data-dropdown][data-open]").forEach(e=>{e.removeAttribute("data-open")})}function N(){return document.querySelector("[data-dropdown][data-open]")}function te(e){let t=e.querySelector(".dropdown-panel");if(!t)return;let n=e.getBoundingClientRect(),o=t.offsetWidth||224,a=(n.width-o)/2,i=n.left+a+o-(window.innerWidth-16);i>0&&(a-=i),n.left+a<8&&(a=8-n.left),t.style.left=`${a}px`,t.style.right="auto"}function De(e){E(),e.setAttribute("data-open",""),te(e)}function ne(e=document){let t=e.querySelectorAll("[data-dropdown]");t.length&&(t.forEach(n=>{if(n.getAttribute("data-dropdown-init")==="1")return;let o=n.querySelector('[role="button"]');if(!o)return;let a=n.querySelector(".dropdown-panel"),i=o.classList.contains("tooltip")&&(o.hasAttribute("data-tooltip-label")||o.hasAttribute("data-tip")||!!o.querySelector(":scope > .tooltip-content"));n.setAttribute("data-dropdown-tooltip",i?"1":"0"),o.addEventListener("click",r=>{r.stopPropagation(),n.hasAttribute("data-open")?E():De(n)}),a&&a.addEventListener("click",r=>r.stopPropagation()),n.setAttribute("data-dropdown-init","1")}),!ee&&(ee=!0,document.addEventListener("click",()=>{N()&&E()}),document.addEventListener("keydown",n=>{n.key==="Escape"&&N()&&E()}),window.addEventListener("resize",()=>{let n=N();n&&te(n)})))}var B={shellPath:"/navbar/",favicon:!0,enablePwa:!0,swPath:"/sw.js",requireAuth:!1,requireAdmin:!1,showMobileMenu:!0,showLanguage:!1,showAppsGrid:!0,showAccountButton:!0,showThemeToggle:!1};typeof window<"u"&&(window.SiteNavConfig={...B,...window.SiteNavConfig||{}});window.__componentsJS=!0;var oe=!1,ae={...B,noCss:!1,showNavbar:!0};function se(){let e=P()||{},t=e.shell&&typeof e.shell=="object"?e.shell:{},n={...ae,...e,...t};return(typeof n.shellPath!="string"||n.shellPath.trim()==="")&&(n.shellPath=ae.shellPath),n}function ce(){return window.location.origin===S}function Ie(e){if(e.enablePwa===!1||!("serviceWorker"in navigator)||!window.isSecureContext)return;let t=typeof e.swPath=="string"&&e.swPath.trim()!==""?e.swPath:"/sw.js";window.addEventListener("load",()=>{navigator.serviceWorker.register(t).catch(()=>{})},{once:!0})}function le(e,t){if(t.noCss||document.querySelector('link[data-shell-style="main"]'))return;let n=e?"":S,o=e?`${n}/css/main.css`:`${n}/css/dui.css`,a=document.createElement("link");a.rel="stylesheet",a.href=o,a.setAttribute("data-shell-style","main"),e||(a.crossOrigin="anonymous"),document.head.appendChild(a);let i=document.createElement("link");i.rel="stylesheet",i.href=`${n}/css/font-awesome.min.css`,i.setAttribute("data-shell-style","fa"),i.media="print",i.onload=function(){this.media="all"},e||(i.crossOrigin="anonymous"),document.head.appendChild(i)}function ue(e,t){if(t.favicon===!1)return;let n=e?"/icons/":`${S}/icons/`;document.querySelectorAll('link[rel="icon"], link[rel="shortcut icon"], link[rel="apple-touch-icon"]').forEach(a=>a.remove());let o=[{rel:"icon",type:"image/png",sizes:"96x96",href:`${n}favicon-96x96-transparent.png`},{rel:"icon",type:"image/svg+xml",href:`${n}favicon.svg`},{rel:"apple-touch-icon",sizes:"180x180",href:`${n}apple-touch-icon-180x180-transparent.png`}];e&&o.push({rel:"shortcut icon",href:`${n}favicon-transparent.ico`}),e&&(document.querySelectorAll('link[rel="manifest"]').forEach(a=>a.remove()),o.push({rel:"manifest",href:`${n}site.webmanifest`})),o.forEach(a=>{let i=document.createElement("link");i.rel=a.rel,a.type&&(i.type=a.type),a.sizes&&(i.sizes=a.sizes),i.href=a.href,!e&&a.rel==="manifest"&&(i.crossOrigin="anonymous"),document.head.appendChild(i)})}function Re(e,t){if(t.showLanguage||e.querySelectorAll('[data-nav-chrome="lang"]').forEach(n=>n.remove()),t.showAppsGrid||e.querySelectorAll('[data-nav-chrome="apps"]').forEach(n=>n.remove()),t.showAccountButton||e.querySelectorAll('[data-nav-chrome="account"]').forEach(n=>n.remove()),t.showThemeToggle||e.querySelectorAll('[data-nav-chrome="theme"]').forEach(n=>n.remove()),!t.showMobileMenu){let n=e.querySelector("#shell-mobile-toggle");if(n){let a=n.closest(".flex-none");a&&a.remove()}let o=e.querySelector("[data-shell-mobile-panel]");o&&o.remove()}}function $e(e){let t=String(e||"").trim();if(!t)return"#";try{let n=new URL(t,window.location.origin);if(n.protocol==="http:"||n.protocol==="https:")return n.href}catch{}return"#"}function Ne(e){let t=String(e||"").trim();return!t||!/^[a-z0-9\s_-]+$/i.test(t)?"fa-solid fa-link":t}function de(e,t){let n=e.querySelectorAll("[data-app-menu-grid]");if(!n.length)return;let o=Array.isArray(t)?t:[];n.forEach(a=>{let r=a.getAttribute("data-app-menu-grid")==="desktop"?"p-3":"p-2.5",l=document.createDocumentFragment();for(let s of o){let c=$e(s?.url),u=Ne(s?.icon),h=String(s?.name||"App").trim()||"App",f=document.createElement("a");f.href=c,f.className=`group flex flex-col items-center gap-1.5 ${r} rounded-md hover:bg-base-200 transition-colors duration-200 no-underline hover:no-underline text-base-content`;let m=document.createElement("div");m.className="w-10 h-10 rounded-md bg-base-300/50 flex items-center justify-center group-hover:bg-primary/10 group-hover:text-primary transition-colors";let y=document.createElement("i");y.className=`${u} text-lg`;let x=document.createElement("span");x.className="text-[10px] font-medium opacity-70 group-hover:opacity-100",x.textContent=h,m.appendChild(y),f.appendChild(m),f.appendChild(x),l.appendChild(f)}a.replaceChildren(l)})}function re(e,t){let n=R(),o=$(n.apps,t);return de(e,o),Promise.resolve(o)}function Be(e){let t=e.querySelector("[data-shell-mobile-panel]");if(!t)return;let n=e.querySelector("#shell-mobile-toggle"),o=t.querySelector("[data-shell-mobile-backdrop]"),a=t.querySelector("[data-shell-mobile-drawer]"),i=t.querySelector("[data-shell-mobile-close]");function r(){t.classList.remove("hidden"),a.offsetWidth,a.style.transform="translateX(0)",document.body.style.overflow="hidden"}function l(){a.style.transform="translateX(-100%)",document.body.style.overflow="",setTimeout(()=>{t.classList.add("hidden")},300)}n&&n.addEventListener("click",r),o&&o.addEventListener("click",l),i&&i.addEventListener("click",l),document.addEventListener("keydown",s=>{s.key==="Escape"&&!t.classList.contains("hidden")&&l()})}function Pe(e,t){let n=e.querySelector("[data-shell-mobile-panel]");if(!n)return;let o=t?.authenticated===!0,a=t?.user,i=n.querySelector('[data-auth="mobile-guest-avatar"]'),r=n.querySelector('[data-auth="mobile-authed-avatar"]'),l=n.querySelector('[data-auth="mobile-name"]'),s=n.querySelector('[data-auth="mobile-email"]'),c=n.querySelector('[data-auth="mobile-login-btn"]'),u=n.querySelector('[data-auth="mobile-logout-btn"]'),h=n.querySelector('[data-auth="mobile-account-btn"]');if(o&&a){if(i&&i.classList.add("hidden"),r){r.classList.remove("hidden");let f=r.querySelector("img");f&&(f.src=a.avatar_url||"")}l&&(l.textContent=a.name||"User"),s&&(s.textContent=a.email||""),c&&c.classList.add("hidden"),u&&u.classList.remove("hidden"),h&&h.classList.remove("hidden")}else i&&i.classList.remove("hidden"),r&&r.classList.add("hidden"),l&&(l.textContent="Guest"),s&&(s.textContent="Not signed in"),c&&c.classList.remove("hidden"),u&&u.classList.add("hidden"),h&&h.classList.add("hidden");u&&(u.onclick=f=>{f.preventDefault();let m=window.AUTH;if(m&&typeof m.logout=="function"){let y=m.logout();y&&typeof y.then=="function"?y.then(()=>window.location.reload()).catch(()=>window.location.reload()):window.location.reload()}}),c&&(c.onclick=f=>{f.preventDefault();let m=window.AUTH;m&&typeof m.login=="function"?m.login():window.location.href="https://auth.dhanur.me"})}function He(e){let t=se(),n=ce(),o=!!document.querySelector('link[rel="stylesheet"][href*="/css/main.css"], link[rel="stylesheet"][href*="/css/dui.css"], link[data-shell-style="main"]'),a=!!document.querySelector('link[rel="icon"], link[rel="shortcut icon"], link[rel="apple-touch-icon"]');(!n||!o)&&le(n,t),(!n||!a)&&ue(n,t),Re(e,t);let i=R();de(e,$(i.apps,"guest")),re(e,"guest"),U(),Q(e),ne(e),Be(e),X(e,r=>{let l=r?.role||"guest",s=V(t,r),c=e.querySelector(".site-nav-slot")||e.querySelector(".drawer-content");if(!s.allowed){c&&Y(c,s.reason,document.title||"This app");return}re(e,l),Pe(e,r)})}async function ie(){if(oe)return;oe=!0;let e=se();if(e.showNavbar===!1)return;Ie(e);let t=ce();if(document.querySelector(".navbar")){t||He(document.body);return}if(!t){le(!1,e),ue(!1,e);return}}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",ie):ie();})();
