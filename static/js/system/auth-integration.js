...
function updateCreditsUI(drawer, credits) {
  ...
  if (sidebarRow) {
    ...
    const sb = sidebarRow.querySelector(
...
function hideCreditsUI(drawer) {
  ...
  drawer
    .querySelector('[data-auth="sidebar-credits-row"]')
...
export function initAuth(drawerElement = document, onAuthResolved = null) {
  ...
  injectAuthSDK(() => {
    ...
    const r = {
      ...
      navLoginItem:
        navbarRoot?.querySelector('[data-auth="login-item"]') || null,
      navAccountItem:
        navbarRoot?.querySelector('[data-auth="account-item"]') || null,
      navLogoutItem:
        navbarRoot?.querySelector('[data-auth="logout-item"]') || null,
      ...
      sidebarLoginBtn:
        sidebarRoot?.querySelector('[data-auth="sidebar-login-btn"]') || null,
      sidebarLogoutBtn:
        sidebarRoot?.querySelector('[data-auth="sidebar-logout-btn"]') || null,
      sidebarAccountBtn:
        sidebarRoot?.querySelector('[data-auth="sidebar-account-btn"]') || null,
    };
